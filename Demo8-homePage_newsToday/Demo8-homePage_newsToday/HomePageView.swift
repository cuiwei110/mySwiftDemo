...
class HomePageView: UIView {
    ...
    fileprivate lazy var collectionView : UICollectionView = {
        ...
        collectionView.register(UINib(nibName: String(describing: UICollectionViewCell.self), bundle: nil), forCellWithReuseIdentifier: String(describing: UICollectionViewCell.self))
